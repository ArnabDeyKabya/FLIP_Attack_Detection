...
| Path                                                                                                                   | Status | Purpose                                      |
| ---------------------------------------------------------------------------------------------------------------------- | ------ | -------------------------------------------- |
| [modules/knn_defense/**init**.py](modules/knn_defense/__init__.py)                                                     | done   | Empty package marker                         |
...
| [modules/train_user_defense/**init**.py](modules/train_user_defense/__init__.py)                                       | done   | Empty package marker                         |
